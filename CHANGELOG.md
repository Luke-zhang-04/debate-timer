...
-   feat(cmd/timer): prevent muting members from other servers

## Security

-   fix(security): prevent ReDOS attacks with RE2

## [1.9.3] - 2021-04-13

### Fixed

-   fix(commands/systemInfo): use native modules to stop some bugs

## [1.9.2] - 2021-04-13

### Changed

-   Development and hosting stuff

## [1.9.1] - 2021-04-12

### Fixed

-   fix: specify file extension for semver module
